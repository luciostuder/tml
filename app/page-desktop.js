          ...
          <div className="">
            {info.map((item, index) => (
              <div key={index} className="mb-20">
                ...
                <div className="flex flex-col md:flex-row gap-2 mt-2 ml-3 lg:ml-24">

                  {/* Projetos + estruturantes */}
                  <div className="mt-4 md:max-w-[40vw] p-4">
                  ...
                  {/* Metricas */}
                  <div className="relative lg:mt-4 ml-2 lg:-ml-4 mb-8 lg:mb-0">
                ...
                {/* TML mobile */}
                <div className="sm:hidden  mt-10 ml-[60px] rounded-r-[2rem] border-[6px] border-l-0 px-4 py-2 mr-8 border-yellow-300">
                  <div className="flex flex-col gap-2 mt-2">

                    {/* A TML */}
                    <div className="h-[6ch] relative -top-12 -right-[25%]  flex flex-row gap-2">
                      <div className="flex flex-row items-center text-lg font-semibold bg-yellow-300  lg:pl-2 pr-4 rounded-full">
                        <Image
                          src="images/TML.svg"
                          alt="4 anos TML"
                          width={70}
                ...
                {/* TML */}
                <div className="hidden sm:inline-block relative mt-10 ml-[60px] lg:ml-[170px] rounded-tl-0 rounded-tr-full  rounded-b-full border-4 px-4 py-2 border-yellow-300">
                  <div className="flex flex-row gap-2 mt-2">

                    {/* A TML */}
                    <div className="relative flex flex-row gap-2 -top-12 -left-12 lg:-left-20 h-[6ch]">
                      <div className="flex flex-row items-center text-lg font-semibold bg-yellow-300  lg:pl-2 pr-4 rounded-full">
                        <Image
                          src="images/TML.svg"
                          alt="4 anos TML"
