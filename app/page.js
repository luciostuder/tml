...
export default function Page() {
  ...
  return (
    ...
    <div className="mx-auto">
      {/* Header */}
      <div className="flex flex-row items-center bg-[rgb(254,222,2)] w-[100vw] gap-5">
        <Image
        ...
        <div className="ml-16">
          {info.map((item, index) => (
            <div key={index}>
              ...
              <div className="flex flex-row gap-2 mt-2 ml-16">
              ...
              {/* TML */}
              <div className="relative mt-14 ml-28 rounded-[50px] border-4 p-4 border-yellow-300 inline-block">
