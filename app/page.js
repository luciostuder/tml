    ...
    <>
              ...
              {info.map((item, index) => (
                <div key={index} className="">
                  ...
                  <div className="ml-[27px] -mt-2 mr-16 p-8 border-8 border-r-0 border-yellow-300 rounded-l-[2rem] ">
                    ...
                    <div className="h-[6ch] relative -top-16 -right-[25%]  flex flex-row gap-2">
                  ...
                  <div className="-mt-2 ml-[60px] mr-4 border-8 px-4 pt-2 border-l-0 border-yellow-300 rounded-r-[2rem] ">
                    <div className="flex flex-col gap-2 mt-2">
                      ...
                      {/* A TML */}
                      <div className="w-40 h-[6ch] relative -top-12   flex flex-row gap-2">
                        <div className="flex flex-row items-center text-lg font-semibold bg-yellow-300  pl-2 pr-4 rounded-full">
                          <Image
                            src="images/TML.svg"
                            alt="4 anos TML"
      ...
      <div className="bg-[rgb(254,222,2)]">
        <div className="mx-auto max-w-[1200px] grid grid-cols-[auto,1fr] bg-[rgb(254,222,2)] gap-5">
          <div className="w-screen w-auto"> {/* Wrapper para evitar limitação */}
            <Image
              src="/images/4anos.png"
              alt="4 anos TML"
              width={500}
          ...
          <div className="flex justify-center items-center pb-0 text-4xl font-bold pr-10">
            Esta é a nossa história
          </div>
        </div>
      </div>
